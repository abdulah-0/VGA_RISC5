// ==============================================================================
// Top-Level FPGA Prototype Wrapper for Digilent Arty A7
// ==============================================================================
`timescale 1ns/1ps

module arty_a7_top (
  input  logic        clk_100mhz,   // 100 MHz On-Board Oscillator (Pin E3)
  input  logic        btn_reset_n,  // Active-Low CPU Reset Pushbutton (Pin C2)
  input  logic [1:0]  sw,           // Slide switches for color mode (Pins A8, C11)
  output logic [3:0]  led,          // 4 Green User LEDs (Pins H5, J5, T9, T10)

  // PMOD JA & JB VGA Interface
  output logic [3:0]  vga_r,        // PMOD JA[3:0] (Pins D12, A11, B11, G13)
  output logic [3:0]  vga_b,        // PMOD JA[7:4] (Pins K16, A18, B18, D13)
  output logic [3:0]  vga_g,        // PMOD JB[3:0] (Pins C15, D15, E16, E15)
  output logic        vga_hsync,    // PMOD JB[7]   (Pin J17)
  output logic        vga_vsync     // PMOD JB[8]   (Pin J18)
);
  ...
  // Map 5/6/5 RGB to 4/4/4 Arty A7 PMOD DAC (take MSBs)
