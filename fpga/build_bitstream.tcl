# ==============================================================================
# Automated Bitstream Generation Script for Digilent Nexys A7 (Artix-7 XC7A100T)
...
puts "==> Building AXI VGA Bitstream for Nexys A7 from: $root_dir"

# 1. Close any open project
catch {close_project}

# 2. Target device: Digilent Nexys A7 (xc7a100tcsg324-1)
set part "xc7a100tcsg324-1"
set proj_dir "$root_dir/build_fpga"
file mkdir $proj_dir
create_project -force nexys_a7_vga_proj $proj_dir -part $part
...
add_files -fileset constrs_1 -norecurse "$script_dir/nexys_a7.xdc"
...
set bit_file "$proj_dir/nexys_a7_vga_proj.runs/impl_1/nexys_a7_top.bit"
if {[file exists $bit_file]} {
    file copy -force $bit_file "$root_dir/nexys_a7_vga.bit"
    puts "================================================================="
    puts " SUCCESS! Bitstream generated:"
    puts "   $root_dir/nexys_a7_vga.bit"
    puts "================================================================="
} else {
    puts "==> [ERROR] Bitstream file was not created!"
}
