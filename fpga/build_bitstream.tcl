# ==============================================================================
# Automated Bitstream Generation Script for Digilent Arty A7 (AXI VGA)
...
puts "==> Building AXI VGA Bitstream from: $root_dir"

# 1. Close any open project
catch {close_project}

# 2. Target device: default to Arty A7-35T (xc7a35tcsg324-1).
# Change to xc7a100tcsg324-1 if using Arty A7-100T.
set part "xc7a35tcsg324-1"
set proj_dir "$root_dir/build_fpga"
file mkdir $proj_dir
create_project -force arty_vga_proj $proj_dir -part $part
...
add_files -fileset constrs_1 -norecurse "$script_dir/arty_a7.xdc"
...
set bit_file "$proj_dir/arty_vga_proj.runs/impl_1/arty_a7_top.bit"
if {[file exists $bit_file]} {
    file copy -force $bit_file "$root_dir/arty_vga.bit"
    puts "================================================================="
    puts " SUCCESS! Bitstream generated at: $root_dir/arty_vga.bit"
    puts "================================================================="
} else {
